...
struct CardView: View {
    ...
    //i added this: callback when cuisine is liked
    let onCuisineLiked: (User) -> Void

    var body: some View {
        ZStack(alignment: .bottom) {
            ZStack(alignment: .top) {
                // Image should be replaced by an image from API
...
private extension CardView {
    ...
    var imageCount: Int { user.profileImageURLS.count }
}
...
private extension CardView {
    ...
    func swipeRight() {
        withAnimation {
            ...
            // Navigate to recipes for this cuisine
            onCuisineLiked(user)

            // keep your existing behavior (remove card after like)
